...
async function runFullPipeline({ imagePath, audioPath, language, category }) {
  ...
  return {
    ...
    detectedLanguage: listing.detectedLanguage,
    craftStory: listing.craftStory,
    suggestedPriceMin: listing.suggestedPriceMin,
    suggestedPriceMax: listing.suggestedPriceMax,
    priceReasoning: listing.priceReasoning,
    category: listing.category,
    suggestedSchemes: listing.suggestedSchemes,
    b2bDescription: listing.b2bDescription,
    wholesalePriceMin: listing.wholesalePriceMin,
    wholesalePriceMax: listing.wholesalePriceMax,
